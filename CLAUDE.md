...
**Limitações conhecidas (não mitigadas):** a mensagem 403 é uniforme (a rota usa texto fixo e o middleware outro, sem distinguir o motivo além disso); não há teste de leitura cruzada de saúde (item 4.5, restante); o esqueleto do cuidador em `Saude.tsx` não é a tela final.
